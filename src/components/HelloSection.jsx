        ...
        <>
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center px-4">
                    <Link to="" className="bg-blue-600 px-6 sm:px-10 py-3 sm:py-4 rounded-xl text-base sm:text-lg hover:bg-blue-700 transition shadow-lg">
                    Découvrir l'église
                    </Link>
                    <Link to="" className="border border-white px-6 sm:px-10 py-3 sm:py-4 rounded-xl text-base sm:text-lg hover:bg-white hover:text-black transition">
                    Nous rejoindre
                    </Link>
                </div>
                </div>
