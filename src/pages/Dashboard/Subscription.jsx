  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-ink/10 bg-white p-4 shadow-sm sm:p-6">
        ...
        <h1 className="text-xl font-serif text-ink sm:text-2xl">Program Access</h1>
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <div className="rounded-3xl border border-ink/10 bg-white p-4 shadow-sm sm:p-6">
          <h2 className="text-lg font-serif text-ink">Already Have a Code?</h2>
          <p className="mt-2 text-xs leading-relaxed text-ink-soft">
            Go to Programs, select your program, enter your email and access code, then view the attached articles.
          </p>
          <Link
            to="/dashboard/programs"
            className="mt-5 inline-flex w-full justify-center rounded-full bg-forest-800 px-5 py-3 text-xs font-semibold text-white transition hover:bg-forest-700 sm:w-auto"
          >
            Unlock articles
          </Link>
        </div>
        ...
        <div className="rounded-3xl border border-ink/10 bg-white p-4 shadow-sm sm:p-6">
          <h2 className="text-lg font-serif text-ink">Need Access?</h2>
          <p className="mt-2 text-xs leading-relaxed text-ink-soft">
          ...
          <Link
            to="/#programs"
            className="mt-5 inline-flex w-full justify-center rounded-full border border-forest-800 px-5 py-3 text-xs font-semibold text-forest-800 transition hover:bg-forest-50 sm:w-auto"
          >
            View programs
          </Link>
        </div>
